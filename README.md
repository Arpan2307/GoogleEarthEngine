...
## 1. Request Parameters  
    ...
    Date Completed: 2023-10-08T08:15:04.710758  

    ID: 99441676-48b2-405e-a944-9dabecbc905e  
    ...
    Details:  
        ...
        Layers:  
                ...
                LST_Day_1km (MYD11A2.061)  
                LST_Night_1km (MYD11A2.061)  
    ...
    Version: This request was processed by AppEEARS version 3.38  

## 2. Request File Listing  

**Supporting Files:**  

- SINGAPORE-MYD11A2-061-metadata.xml
- SINGAPORE-granule-list.txt
- SINGAPORE-request.json
- MYD11A2-061-QC-Day-lookup.csv
- MYD11A2-061-QC-Night-lookup.csv
- MYD11A2-061-QC-Day-Statistics-QA.csv
- MYD11A2-061-QC-Night-Statistics-QA.csv
- MYD11A2-061-Statistics.csv
...
Alaska:
    ...
    "+proj=aea +lat_0=50 +lon_0=-154 +lat_1=55 +lat_2=65 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs"

Hawaii:

    "+proj=aea +lat_0=3 +lon_0=-157 +lat_1=8 +lat_2=18 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs"
...
- Wan, Z., Hook, S., Hulley, G. (2021). MODIS/Aqua Land Surface Temperature/Emissivity 8-Day L3 Global 1km SIN Grid V061. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2023-10-08 from https://doi.org/10.5067/MODIS/MYD11A2.061. Accessed October 8, 2023.

## 10. Software Citation  

AppEEARS Team. (2023). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.38. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed October 8, 2023. https://appeears.earthdatacloud.nasa.gov
